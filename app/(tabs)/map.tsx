...
const styles = StyleSheet.create({
  ...
  pinText: { fontSize: 18 },
  pinRatedText: { fontSize: 13, fontWeight: '800', color: Colors.white },
  ...
  scoreText: { color: Colors.white, fontSize: 13, fontWeight: '800' },
  ...
  unratedText: { fontSize: 11, color: Colors.muted, fontWeight: '600' },
