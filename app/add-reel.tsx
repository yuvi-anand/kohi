      ...
      <ScrollView contentContainerStyle={styles.body} keyboardShouldPersistTaps="handled">
        ...
        >
          {processing ? (
            ...
            <Text style={styles.processBtnText}>Process Link</Text>
          )}
        </TouchableOpacity>
        ...
        {processing && (
          <View style={styles.loadingCard}>
            ...
            <Text style={styles.loadingText}>Extracting coffee shop info…</Text>
          </View>
        )}
          ...
          <View style={styles.resultCard}>
            ...
            <View style={styles.resultBody}>
              ...
              {result.extracted_summary && (
                <Text style={styles.summary}>"{result.extracted_summary}"</Text>
              )}
              {result.shop ? (
            ...
            >
              {saving ? (
                ...
                <Text style={styles.saveBtnText}>Save to Want to Try</Text>
              )}
            </TouchableOpacity>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  processBtn: {
    backgroundColor: Colors.caramel, borderRadius: 8,
  ...
  saveBtn: {
    backgroundColor: Colors.caramel, margin: 16, marginTop: 0,
